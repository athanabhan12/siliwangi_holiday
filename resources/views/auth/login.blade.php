...
<body class="login">
	<div class="wrapper wrapper-login">
		<div class="container container-login animated fadeIn">
			<h3 class="text-center">Siliwangi Holiday</h3>
            <img src="assets/img/logo/logo_tour.png" width="200px"  style="display: block; margin-left: auto; margin-right: auto;">
			<div class="login-form">
				<form action="" method="POST">
					@csrf
				<div class="form-group form-floating-label">
					<input id="username" name="username" type="text" class="form-control input-border-bottom @error('email') is-invalid @enderror" required>
